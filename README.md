# FieldDataCollection_DataCollectionProcedures_LoadRawDataToMATLAB
...
<p align="center">
  ...
  <h2 align="center"> FieldDataCollection_DataCollectionProcedures_LoadRawDataToMATLAB
  </h2>

  <pre align="center">
    <img src=".\Images\FieldDataCollection_DataCollectionProcedures_LoadRawDataToMATLAB.jpg" alt="main FieldDataCollection_DataCollectionProcedures_LoadRawDataToMATLAB picture" width="960" height="540">
    <!--figcaption>Fig.1 - The typical progression of map generation.</figcaption -->
    <font size="-2">Photo by <a href="https://unsplash.com/@mike_van_den_bos?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Mike van den Bos</a> on <a href="https://unsplash.com/photos/text-jf1EomjlQi0?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a></font>
</pre>
...
<a href="#fielddatacollection_datacollectionprocedures_loadrawdatatomatlab">Back to top</a>
...
2. Clone the repo
   ...
   ```sh
   git clone https://github.com/ivsg-psu/FieldDataCollection_DataCollectionProcedures_LoadRawDataToMATLAB
   ```
...
Project Link: [hhttps://github.com/ivsg-psu/FieldDataCollection_DataCollectionProcedures_LoadRawDataToMATLAB](https://github.com/ivsg-psu/FieldDataCollection_DataCollectionProcedures_LoadRawDataToMATLAB)
