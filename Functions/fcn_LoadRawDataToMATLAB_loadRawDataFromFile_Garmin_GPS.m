function GPS_Garmin = fcn_LoadRawDataToMATLAB_loadRawDataFromFile_Garmin_GPS(file_path,datatype,fid)
...
% UPDATES:
% As: fcn_DataClean_loadRawDataFromFile_Garmin_GPS
...
% * In fcn_LoadRawDataToMATLAB_loadRawDataFromFile_Garmin_GPS
% -- Renamed function to fcn_LoadRawDataToMATLAB_loadRawDataFromFile_Garmin_GPS
...
if strcmp(datatype,'gps')
    ...
    GPS_Garmin = fcn_LoadRawDataToMATLAB_initializeDataByType(datatype);
