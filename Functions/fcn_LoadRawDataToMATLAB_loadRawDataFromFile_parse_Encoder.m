function parseEncoder = fcn_LoadRawDataToMATLAB_loadRawDataFromFile_parse_Encoder(file_path,datatype,fid)
...
if strcmp(datatype,'encoder')
    ...
    parseEncoder = fcn_LoadRawDataToMATLAB_initializeDataByType(datatype,Npoints);
    % secs = datatable.secs;
