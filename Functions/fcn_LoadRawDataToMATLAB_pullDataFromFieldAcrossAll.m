function [dataArray, sensorNames] = fcn_LoadRawDataToMATLAB_pullDataFromFieldAcrossAll(dataStructure, field_string, varargin)
...
% EXAMPLES:
%
%     See the script: script_test_fcn_LoadRawDataToMATLAB_pullDataFromFieldAcrossAll
...
%
% As: fcn_LoadRawDataToMATLAB_pullDataFromFieldAcrossAll
%
...
sensorNames = fcn_LoadRawDataToMATLAB_findMatchingSensors(dataStructure, sensor_identifier_string);
