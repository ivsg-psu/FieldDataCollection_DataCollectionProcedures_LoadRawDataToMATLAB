% script_test_fcn_LoadRawDataToMATLAB_loadRawFromFile_Encoder
% Tests: fcn_LoadRawDataToMATLAB_loadRawFromFile_Encoder


% REVISION HISTORY
% 
% As: script_test_fcn_LoadRawDataToMATLAB_loadRawFromFile_Encoder
% 
...
%% DEMO case: Load one encoder file
figNum = 10001;
titleString = sprintf('DEMO case: Load one encoder file');
fprintf(1,'Figure %.0f: %s\n',figNum, titleString);
figure(figNum); close(figNum);

filePath = fullfile(pwd,'Data','TestLoadData','_slash_parseEncoder.csv');
datatype = 'encoder';

% Call the function
structureEncoder = fcn_LoadRawDataToMATLAB_loadRawFromFile_Encoder(filePath, datatype, (figNum));
...
% Call the function
structureEncoder = fcn_LoadRawDataToMATLAB_loadRawFromFile_Encoder(filePath, datatype, ([]));
...
% Call the function
structureEncoder = fcn_LoadRawDataToMATLAB_loadRawFromFile_Encoder(filePath, datatype, (-1));
