function GPS_Novatel = fcn_LoadRawDataToMATLAB_loadRawDataFromFile_Novatel_GPS(file_path,datatype,flag_do_debug)
...
% UPDATES:
% As: fcn_DataClean_loadRawDataFromFile_Novatel_GPS
...
% * In fcn_LoadRawDataToMATLAB_loadRawDataFromFile_Novatel_GPS
% -- Renamed function to fcn_LoadRawDataToMATLAB_loadRawDataFromFile_Novatel_GPS
...
if strcmp(datatype,'gps')
    ...
    GPS_Novatel = fcn_LoadRawDataToMATLAB_initializeDataByType(datatype,Npoints);
